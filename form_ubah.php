...
<tr>
    ...
    <td><input type="text" name="txtnim" value="<?php echo $row [1] ?>"></td>
</tr>

<tr>
    <td>Semester</td>
    <td><input type="text" name="txtnim" value="<?php echo $row [2] ?>"></td>
</tr>

<tr>
    <td>Fakultas</td>
    <td><input type="text" name="txtnim" value="<?php echo $row [3] ?>"></td>
</tr>

<tr>
    <td>Jurusan</td>
    <td><input type="text" name="txtnim" value="<?php echo $row [4] ?>"></td>
</tr>
